                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="infoAction" action="infoAboutEmployee.html" method="POST">
                            ...
                            <button type = "submit" name = "infoActionId" value = "${manager.getId()}" title="Info about employee">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="infoAction" action="infoAboutEmployee.html" method="POST">
                            ...
                            <button type = "submit" name = "infoActionId" value = "${developer.getId()}" title="Info about employee">
                                <img src="img/info.png">
                            </button>
                        </form>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form class="infoAction" action="infoAboutEmployee.html" method="POST">
                            ...
                            <button type = "submit" name = "infoActionId" value = "${cleaner.getId()}" title="Info about employee">
                                <img src="img/info.png">
                            </button>
                        </form>
                    </td>
